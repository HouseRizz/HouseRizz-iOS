//
//  AddProductCategoriesView.swift
//  HouseRizz-iOS
//
...
struct AddProductCategoriesView: View {
    @StateObject private var viewModel = AddProductCategoriesViewModel()
...
extension AddProductCategoriesView {
    @ViewBuilder
    var categoryPhotoPicker: some View {
        HStack {
